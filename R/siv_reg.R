#' This function performs Instrumental Variable Regression using a single synthetic IV.
#'
#' The synthetic IV is identified using the dual tendency DT condition for coplanar regression vectors.
